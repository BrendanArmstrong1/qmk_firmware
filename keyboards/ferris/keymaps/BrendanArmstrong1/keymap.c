...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_SYMBOL] = LAYOUT( /* [> SYMBOL <] */
     ...
     KC_ESC, KC_SLSH, KC_CIRC, KC_ASTR,  KC_QUES,           KC_ENT, KC_LCBR,  KC_PERC, KC_RCBR, KC_BSLS,
  ...
  [_MATH] = LAYOUT( /* [> MATH <] */
            MO(3), KC_COMM,  KC_DOT, KC_SCLN, KC_PLUS,         KC_MINS, KC_1, KC_2, KC_3, KC_BSPC,
  ...
  [_SPECIAL] = LAYOUT( /* [> SPECIAL <] */
    KC_TRNS, KC_LEFT,    KC_DOWN,        KC_UP, KC_RIGHT,                   KC_DEL, DM_REC1, DM_PLY1, KC_BTN2, KC_WH_U,
      MO(4),   KC_NO, LCTL(KC_C), LSFT(KC_INS), LCTL(KC_V),                KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_BTN1,
